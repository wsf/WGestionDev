...
On Error Resume Next
    ...
    Select Case vVieneImpresion
        ...
        Case "frmArticulos"
            ...
            If Not Trim(txtArticulos(8).Text) = "" And Not Trim(txtArticulos(10).Text) = "" Then
                vsql = vsql + " AND (idRubros >= '" & Trim(txtArticulos(8).Text) & "' AND idRubros  <=  '" & Trim(txtArticulos(10).Text) & "')"
            End If
            
            If Not Trim(txtArticulos(12).Text) = "" And Not Trim(txtArticulos(14).Text) = "" Then
                vsql = vsql + " AND (idSubRubros >= '" & Trim(txtArticulos(12).Text) & "' AND idSubRubros  <=  '" & Trim(txtArticulos(14).Text) & "')"
            End If
                    ...
                    Select Case i
                        ...
                        Case 0
                            With drReporte
                                ...
                                .Sections("PieInforme").Controls("total07").DataField = "Valorizacion"
                            ...
                            If Me.rbClientes Then
                               ...
                               .Sections("DetalleInforme").Controls("txtCampo08").DataField = "PVentaConIva"
                                ...
                                .Sections("DetalleInforme").Controls("txtCampo02").DataField = "pventa5"
                                .Sections("TituloEmpresa").Controls("lblCampo02").Caption = "Descripcion"
                               ...
                               .Sections("DetalleInforme").Controls("txtCampo05").DataField = "pventa5"
                                ...
                                .Sections("PieInforme").Controls("total07").DataField = "pventa5"

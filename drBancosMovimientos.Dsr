VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drBancosMovimientos 
   Bindings        =   "drBancosMovimientos.dsx":0000
   ClientHeight    =   11115
   ClientLeft      =   60
   ClientTop       =   315
   ClientWidth     =   19080
   ...
   BeginProperty Section4 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item4 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Totales del período:"
         CanGrow         =   -1  'True
         Alignment       =   1
      EndProperty
      ItemType5       =   6
   ...
   EndProperty
End
Attribute VB_Name = "drBancosMovimientos"

...
Dim rsBancoCajaDetalle As New ADODB.Recordset
...
With rsBancoCajaDetalle
    ...
    If rsBancoCajaDetalle.State = 1 Then
        rsBancoCajaDetalle.Close
        Set rsBancoCajaDetalle = Nothing
    End If
...
If Not vValor = 0 Then
    MsgBox "El periódos " + Format(vidanomes, "0000/00") + _
    " está cerrado."
...
If vValor > 0 Then
    MsgBox "Este més ya fue cerrado "
...
Private Sub cargarRenglonIE(vimporte As Double, vnroorden As Integer, vidVale As Long)
...
If vidanomes > 0 Then
    drCajaCierreSaldos.Sections("TituloEmpresa").Controls("efiltro").Caption = "Balance de composición de saldos correspontiende al mes: " + Format(vidanomes, "0000/00")
Else

VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drventas_articulos 
   Bindings        =   "drventas_Articulos.dsx":0000
   Caption         =   "Impresión de estadística de ventas por Artículos"
   ClientHeight    =   11490
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   19080
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item5 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BackColor       =   14737632
         BackStyle       =   1
         Object.Caption         =   "Estadística de Ventas por Artículos"
         Alignment       =   2
      EndProperty
      ItemType6       =   3
   ...
   BeginProperty Section4 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item6 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   645
         Object.Height          =   480
         Picture         =   "drventas_Articulos.dsx":001C
         SizeMode        =   1
      EndProperty
   EndProperty
End
Attribute VB_Name = "drventas_articulos"

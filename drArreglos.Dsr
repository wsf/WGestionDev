VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drArreglos 
   Bindings        =   "drArreglos.dsx":0000
   Caption         =   "Listado de Arreglo de Saldos"
   ClientHeight    =   6135
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10650
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item3 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Listado de Clientes con dif. precios"
         Alignment       =   1
      EndProperty
      ItemType4       =   3

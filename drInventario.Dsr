VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drListadoArticulosCP 
   Bindings        =   "drInventario.dsx":0000
   Caption         =   "Listado de artículo según criterio seleccionado"
   ClientHeight    =   11040
   ClientLeft      =   60
   ClientTop       =   315
   ClientWidth     =   15240
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item6 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BackColor       =   0
         BackStyle       =   1
         Object.Caption         =   "Precio de Venta"
         Alignment       =   2
      EndProperty
      ItemType7       =   3
   ...
   EndProperty
End
Attribute VB_Name = "drListadoArticulosCP"

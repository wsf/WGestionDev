VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} ifacta 
   Bindings        =   "imonotributo.dsx":0000
   ...
   EndProperty
End
Attribute VB_Name = "ifacta"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub DataReport_Initialize()
    Me.Sections("Detalle").Height = margenfactura
    Me.Sections(3).Height = 0
    
    ' Ale: este es el ifacta
    'Me.Sections("detalle").Controls("tdtotal"fi
End Sub

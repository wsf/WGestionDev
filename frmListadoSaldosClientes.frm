...
End If
    ...
    If chkAceptados.Value Then
        vsql = FSQLSaldos(vsqlFecha, vctacteCP, Me.vtipoProveedor, vcondi, "Aceptados")
    Else
        vsql = FSQLSaldos(vsqlFecha, vctacteCP, Me.vtipoProveedor, vcondi)
    End If
    ...
    With Mantenimiento.rsSaldosClientes

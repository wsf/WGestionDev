        ...
        Select Case vModo
            ...
            Case 0
                ...
                Else
                    ...
                    .Recordset("IVA105").Value = TraerDato("IvaFacturaCompra ", "nrointerno = " & Str(bPFactura.Recordset("nrointerno").Value) + " order by idivafacturacompra desc", "Iva105")
                    .Recordset("IVA210").Value = TraerDato("IvaFacturaCompra ", "nrointerno = " & Str(bPFactura.Recordset("nrointerno").Value) + " order by idivafacturacompra desc", "Iva210")
                    .Recordset("IVA270").Value = TraerDato("IvaFacturaCompra ", "nrointerno = " & Str(bPFactura.Recordset("nrointerno").Value) + " order by idivafacturacompra desc", "Iva270")
                ...
                vRetenciones = TraerDato("IvaFacturaCompra", "nrointerno = " & Str(bPFactura.Recordset("nrointerno").Value) + " order by idivafacturacompra desc ", "Retenciones")
                vPercepciones = TraerDato("IvaFacturaCompra", "nrointerno = " & Str(bPFactura.Recordset("nrointerno").Value) + " order by idivafacturacompra desc ", "Percepciones")
                vNoGravado = TraerDato("IvaFacturaCompra", "nrointerno = " & Str(bPFactura.Recordset("nrointerno").Value) + " order by idivafacturacompra desc ", "Nogravado")
                vImpExento = TraerDato("IvaFacturaCompra", "nrointerno = " & Str(bPFactura.Recordset("nrointerno").Value) + " order by idivafacturacompra desc ", "ImpExento")
                ...
                '.Recordset("Retenciones").Value = TraerDato("IvaFacturaCompra", "nrointerno = " & bPFactura.Recordset("nrointerno").Value, "Retenciones")
                '.Recordset("Percepciones").Value = TraerDato("IvaFacturaCompra", "nrointerno = " & bPFactura.Recordset("nrointerno").Value, "Percepciones")
                '.Recordset("Nogravado").Value = TraerDato("IvaFacturaCompra", "nrointerno = " & bPFactura.Recordset("nrointerno").Value & "", "Nogravado")
                '.Recordset("ImpExento").Value = TraerDato("IvaFacturaCompra", "nrointerno = " & bPFactura.Recordset("nrointerno").Value & "", "ImpExento")
               ...
               vtipo = Trim(.Recordset("Tipo").Value)
                ...
                If vtipo = "Nota C" Then
                        ...
                        .Recordset("IVA105").Value = -1 * TraerDato("IvaFacturaCompra", "nrointerno = " & Str(bPFactura.Recordset("nrointerno").Value) + " order by nrointerno desc ", "Iva105")
                        .Recordset("IVA210").Value = -1 * TraerDato("IvaFacturaCompra", "nrointerno = " & Str(bPFactura.Recordset("nrointerno").Value) + " order by nrointerno desc ", "Iva210")
                        .Recordset("IVA270").Value = -1 * TraerDato("IvaFacturaCompra", "nrointerno = " & Str(bPFactura.Recordset("nrointerno").Value) + " order by nrointerno desc ", "Iva270")

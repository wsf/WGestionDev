VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} ifactaPoli 
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item25 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Nro. Comprobante:"
         Alignment       =   1
      EndProperty
      ItemType26      =   3
      ...
      EndProperty
      ItemType40      =   7
      BeginProperty Item40 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
         Name            =   "logo2"
         Object.Left            =   6510
         Object.Top             =   1260
   ...
   BeginProperty Section3 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item21 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "12345678910111213"
      EndProperty
      ItemType22      =   3
      BeginProperty Item22 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
...
If UCase(LeerXml("logo")) = "NO" Then

 ifactaPoli.Sections("titulos").Controls("logo").Visible = False

Else

 ifactaPoli.Sections("titulos").Controls("logo").Visible = True
 
Set ifactaPoli.Sections("titulos").Controls("logo").Picture = LoadPicture(App.Path + "\logo" + Trim(v) + ".jpg")
...
If Not LeerXml("CUIT") = "" Then
    ifactaPoli.Sections("titulos").Controls("CUIT").Caption = "C.U.I.T. : " + LeerXml("CUIT")
End If

If Not LeerXml("IB") = "" Then
    ifactaPoli.Sections("titulos").Controls("IB").Caption = "Ingresos Brutos: " + LeerXml("IB")
End If

If Not LeerXml("IBFecha") = "" Then
    ifactaPoli.Sections("titulos").Controls("IBFecha").Caption = "Inicio Actividad: " + LeerXml("IBFecha")
End If


If vnroempresa > 0 Then

        'ifactaPoli.Sections("titulos").Controls("logo").Visible = True
        
        If Not InStr(UCase(LeerXml("UEmpresa")), "POLI") > 0 Then
            ifactaPoli.Sections("titulos").Controls("logo2").Visible = False
        End If
        
End If

        
ifactaPoli.Sections("titulos").Controls("eeEmpresa").Caption = eeEmpresa
ifactaPoli.Sections("titulos").Controls("eeDireccion").Caption = eeDireccion
ifactaPoli.Sections("titulos").Controls("eeLocalidad").Caption = eeLocalidad
ifactaPoli.Sections("titulos").Controls("eeCuit").Caption = eeCuit
ifactaPoli.Sections("titulos").Controls("eeIngresosBrutos").Caption = eeIngresosBrutos
ifactaPoli.Sections("titulos").Controls("eeOtros").Caption = veeOtros



'Picture = LoadPicture(App.Path + "\logo" + Trim(v) + ".jpg")

If InStr(UCase(LeerXml("UEmpresa")), "POLI") > 0 Or InStr(UCase(LeerXml("UEmpresa")), "WGESTIONTITO") > 0 Then
    Set ifactaPoli.Sections("titulos").Controls("logo2").Picture = LoadPicture(App.Path + "\logo2.jpg")
        ifactaPoli.Sections("titulos").Controls("logo2").Visible = True

...
Dim vgrow As Integer
Public vdocmarcados As Integer
Public vTipoComprobante As Integer
...
Dim vpap2, vvalorespap2 As String
...
Private Sub pintarlinea(l As Integer)
Dim i, j As Integer
...
Private Sub imprimeUnaFactura(vremito As Long, vTipoDocumento As String, vncomprobante As Integer)
...
Function getTipoComprobante(vdato As String) As Integer
...
sqlAgrupa_persona = "select  t.codigo, t.nombre, " & _
 " cast(sum(total) as decimal(10,2)) as Deuda, cast(sum(t.`pagoparcial`) as decimal(10,2)) as Pago, cast((sum(t.`pagoparcial`) / sum(total)) as decimal(10,2)) as Por " & _
 "fro" & _
 "m " + cpFactura + " t where 1=1 " + vwhere + "  group by t.codigo order by t.nombre asc"
...
Public Sub formatGrillaDoc(Col As Integer, vformato As String)
Dim i As Integer
...
Private Sub llenarDetalles2(vremito As Long)
On Error Resume Next
...
Private Sub llenarlinea2(vi As Integer, vCantidad As Double, vDetalle As String, vPrecio As Double, vdesc As Double, vtotal As Double)
...
Private Sub llenarDocumentos2(vtipo As String, vncomprobante As Integer)
...
Private Sub mostrar_Doc2(vtipo As String, vncomprobante As Integer)
...
Private Sub mostrar_documentos(vnrocomprobante As Integer)

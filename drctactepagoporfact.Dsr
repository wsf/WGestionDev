VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drPagoPorFactura 
   Bindings        =   "drctactepagoporfact.dsx":0000
   Caption         =   "Cuentas Corrientes de Clientes - Pago Por Facturas"
   ClientHeight    =   11010
   ClientLeft      =   60
   ClientTop       =   315
   ClientWidth     =   15240
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item12 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         BackStyle       =   1
         Object.Caption         =   "Listado de mov. agrupados por Facturas"
         Alignment       =   1
      EndProperty
      ItemType13      =   3
   ...
   EndProperty
End
Attribute VB_Name = "drPagoPorFactura"
